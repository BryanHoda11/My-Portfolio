    ...
    <>
      ...
      <div className="intro-container flex flex-col lg:flex-row mt-12 lg:mt-0 justify-center lg:justify-around items-center lg:min-h-[700px] w-full">
        <div className="info flex flex-col items-center lg:items-start gap-3 w-full lg:w-1/2 px-0 sm:px-6">
          ...
          <button className='bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg text-sm md:text-lg px-5 py-2 my-3 cursor-pointer hover:from-blue-600 hover:to-blue-500 transition-all duration-200 w-fit'><a className='text-white font-bold' href="https://documentcloud.adobe.com/gsuiteintegration/index.html?state=%7B%22ids%22%3A%5B%221KdR_ClSKI9P6Jpj2Tn27aQWmaiwQ8GYy%22%5D%2C%22action%22%3A%22open%22%2C%22userId%22%3A%22109536557876944904708%22%2C%22resourceKeys%22%3A%7B%7D%7D" target='_blank'>MY RESUME</a></button>
        </div>
