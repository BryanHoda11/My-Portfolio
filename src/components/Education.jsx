                ...
                <div className="school flex flex-col-reverse lg:flex-row items-center justify-around">
                    ...
                    <div className="school-info w-full px-3 lg:px-0 lg:w-1/2">
                        ...
                        <div className="flex flex-col py-5 gap-3">
                            ...
                            <p className='text-sm'>I passed out this English convent school based in 4 Bungalows Mhada Lane Andheri West. I was in this school right from Jr.Kg all the way to STD. X ICSE board. It was a fun experience, got to learn and grow. What I am today a part of that my school plays a role.</p>
                            <p className='pt-3 text-start'>STD. X Percentage - <span className='font-bold'>83%</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div className="jrcollege flex flex-col lg:flex-row items-center justify-around my-12">
                    <div className="jrcollege-info w-full px-3 lg:px-0 lg:w-1/2">
                        ...
                        <div className="flex flex-col py-5 gap-3">
                            ...
                            <p className='pt-3 text-start'>STD. XII Percentage - <span className='font-bold'>80%</span></p>
                        </div>
                    </div>
                ...
                <div className="graduation flex flex-col-reverse lg:flex-row items-center justify-around my-12">
                    ...
                    <div className="graduation-info w-full px-3 lg:px-0 lg:w-1/2">
                        ...
                        <div className="flex flex-col py-5 gap-3">
                            ...
                            <p className='text-sm'>I persued my B.COM through this college located in Yari Road, Versova, Andheri West. My overall experience throughout my 3 years was really fun. Learnt a lot of new things, met new people & gathered a ton of real world knowledge! I was thrilled and excited as <span className='font-bold'>I topped my college in 4 out of the total 6 semesters</span>, which was a big morale booster for me. Grateful to this college for where I am today.</p>
                            <p className='pt-3 text-start'>Graduation CGPA - <span className='font-bold'>8.20</span></p>
                        </div>
                    </div>
                </div>
            </div>
