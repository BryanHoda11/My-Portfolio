...
const Hero = () => {
  return (
    <>
      <div className="intro-container flex flex-col max-lg:gap-5 lg:flex-row max-lg:mt-7 justify-center lg:justify-center items-center lg:min-h-[700px] w-full">
        <div className="info flex flex-col items-center lg:items-start justify-center gap-3 sm:gap-5 w-full lg:w-1/2 px-4 sm:px-8">
          ...
          <a href="https://drive.google.com/file/d/188sQeukfD76JGImM1LoGOmN_WFsf4Q8m/view?usp=sharing" target="_blank" className="group">
        ...
        <div className="image shadow-xl w-fit">
          <img className='h-auto max-w-xs sm:w-96 lg:max-w-md xl:max-w-lg rounded-lg object-cover' src={MyPic} alt="MyPicture" />
        </div>
      </div>
    </>
  )
